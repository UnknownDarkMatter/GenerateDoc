...
public class RuleMarkDownVisitor : BaseMarkDownVisitor
{
    public RuleMarkDownVisitor(FileContent fileContent, CommandLineOptions commandLineOptions) : base(fileContent, commandLineOptions)
    {
    }
