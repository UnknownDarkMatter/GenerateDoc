...
public class TagHtmlVisitor : BaseHtmlVisitor
{
    public TagHtmlVisitor(FileContent fileContent, CommandLineOptions commandLineOptions): base(fileContent, commandLineOptions)
    {
    }
